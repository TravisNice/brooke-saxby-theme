<?php
	...
	function bs_theme_support_setup()
	{
		...
		$args = array(
			'default-image' => get_template_directory_uri() . 'img/push-ups.jpg',
		...
		$header_images = array(
			'push-ups' => array(
				'url' => get_template_directory_uri() . 'img/push-ups.jpg',
				'thumbnail_url' => get_template_directory_uri() . 'img/push-ups.jpg',
				'Description' => 'Brooke Saxby'
			)
		);
